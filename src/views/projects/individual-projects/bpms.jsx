function BPMS() {
    return (
        <div className="flex flex-col size-full">
            <h1 className="text-xl text-center">Department Specific BPMS (Business Process Management Systems)</h1>
            <div className="flex flex-wrap mt-2 w-full place-content-center gap-2">
                <div className="badge badge-accent">WPF</div>
                <div className="badge badge-accent">C#</div>
                <div className="badge badge-accent">MSSQL</div>
                <div className="badge badge-accent">T-SQL</div>
