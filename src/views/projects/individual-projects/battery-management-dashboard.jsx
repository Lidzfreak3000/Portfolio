function BatteryManagementDashboard() {
    return (
        <div className="flex flex-col size-full">
            <h1 className="text-xl text-center">Battery Management Dashboard</h1>
            <div className="flex flex-wrap mt-2 w-full place-content-center gap-2">
                ...
                <div className="badge badge-accent">SCADA</div>
                <div className="badge badge-accent">Azure</div>
                <div className="badge badge-accent">SPA</div>
                <div className="badge badge-accent">Microservices</div>
            </div>
