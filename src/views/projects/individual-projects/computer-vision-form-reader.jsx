function ComputerVisionFormReader() {
    return (
        <div className="flex flex-col size-full">
            <h1 className="text-xl text-center">Computer Vision Form Reader</h1>
            <div className="flex flex-wrap mt-2 w-full place-content-center gap-2">
                <div className="badge badge-accent">Python</div>
                <div className="badge badge-accent">React Native</div>
                <div className="badge badge-accent">OpenCV</div>
                <div className="badge badge-accent">OCR</div>
