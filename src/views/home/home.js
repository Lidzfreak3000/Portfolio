            ...
            <ChatMessage id="5" delay={defaultDelay} currentMessage={currentMessage}>
                <div className="space-x-4">
                    <div className="tooltip tooltip-secondary" data-tip="LinkedIn">
                        <a className="btn btn-circle btn-soft btn-secondary" href="https://www.linkedin.com/in/john-r-duncan/">
                    ...
                    <div className="tooltip tooltip-secondary" data-tip="GitHub">
                        <a className="btn btn-circle btn-soft btn-secondary" href="https://github.com/Lidzfreak3000">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6 fill-current text-black">
